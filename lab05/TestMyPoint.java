public class TestMyPoint {
    public static void main(String[] args) {
        ...
        System.out.println(p2.distance(p1)); // 5.0
        System.out.println(p1.distance(5, 6)); // 6.324555320336759
        System.out.println(p1.distance()); // 3.0

        MyPoint[] points = new MyPoint[10];  // Declare and allocate an array of MyPoint
        for (int i = 0; i < points.length; i++) {
            points[i] = new MyPoint(i, i + 1);    // Allocate each of MyPoint instances
        }
